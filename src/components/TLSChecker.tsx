...
export const TLSChecker = () => {
  ...
  return (
    <div className="relative bg-white rounded-2xl shadow-lg p-6">
      {/* Coming Soon Overlay */}
      <div className="absolute inset-0 bg-gray-200/80 backdrop-blur-sm rounded-2xl flex flex-col items-center justify-center z-10">
        <span className="text-3xl font-bold text-gray-700">Coming Soon</span>
        <p className="text-gray-600 mt-2">PQ-TLS Analysis Feature</p>
      </div>

      {/* Existing Component (greyed out) */}
